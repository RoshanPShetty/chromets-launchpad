# Chrome Extension Template with React and Tailwind CSS

This template provides a foundation for creating Chrome extensions using React and Tailwind CSS.
...
2. Import and use them in `popup.tsx` or `content.tsx`
